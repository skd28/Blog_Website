      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
        <div className="grid mb-8 lg:grid-cols-6">
          ...
          <div className=" md:max-w-md lg:col-span-2 lg:mt-0 mt-5  ">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              Voluptate vel harum vitae natus accusantium ratione! Magnam quis
              illo quisquam harum asperiores voluptate, numquam reprehenderit
              distinctio tempora fuga aut, suscipit accusamus?
            </p>
          </div>
        </div>
        ...
        <div className=" flex flex-col justify-between pt-5 pb-10 border-t  border-gray-800 sm:flex-row ">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href=""
              className="text-gray-500 translate-all duration-300 hover:text-orange-500"
            >
